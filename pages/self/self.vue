		...
		<view v-if="userInfo" class="my-header">
			...
			<view class="my-header-info">
				...
				<view class="my-header-info-box">
					...
					<text>{{userInfo.fans_count?userInfo.fans_count:0}}</text>
				</view>
			</view>
		</view>
		...
		<view class="my-content">
			<view v-if="!userInfo" class="my-content-list" @click="goLoginPage">
				<view class="my-content-list-title">
					<image class="company-logo" src="../../static/img/login_bg.png" mode="aspectFill"></image>
					<text>HI，您尚未登录,请点击登录</text>
				</view>
				<uni-icons type="arrowright" size="14" color="#666"></uni-icons>
			</view>
			<view class="my-content-list" @click="goMyself">
				<view class="my-content-list-title">
			...
			<view class="my-content-list" @click="goMessageBack">
				<view class="my-content-list-title">
...
<script>
	export default {
		...
		methods: {
			...
			async getUpload(filePath, cloudPath) {
				const {
					fileID
